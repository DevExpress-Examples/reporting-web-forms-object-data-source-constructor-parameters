...
Namespace WebApplication1
    Partial Public Class WebForm1
        ...
        Private Function GenerateReport(ByVal parameterName As String, ByVal dataSource As Object) As XtraReport
            ...
            report.Parameters.Add(New DevExpress.XtraReports.Parameters.Parameter() With { _
        ...
        Private Shared Sub CreateReportControls(ByVal parameterName As String, ByVal report As XtraReport)
            ...
            Dim paramValueLbl = New XRLabel() With { _
                .Name = "label1", _
                .Borders = DevExpress.XtraPrinting.BorderSide.Bottom, _
            ...
            Dim xrLabel1 = New XRLabel() With { _
                .Name = "label1", _
                .Font = New System.Drawing.Font("Calibri", 18.0F), _
                .SizeF = New System.Drawing.SizeF(200, 50), _
        ...
        Private Function GenerateObjectDataSource(ByVal reportParamName As String, ByVal dataSourceParamName As String) As Object
            ...
            Dim p = New DevExpress.DataAccess.ObjectBinding.Parameter( _
                    dataSourceParamName, _
                    GetType(DevExpress.DataAccess.Expression), _
